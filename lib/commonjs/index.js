...
var _exportNames = {
  ...
  getAllHealthKitPermissions: true,
  requestAllHealthKitPermissions: true,
...
exports.getAllHealthKitPermissions = getAllHealthKitPermissions;
...
exports.requestAllHealthKitPermissions = requestAllHealthKitPermissions;
...
@Only available on iOS
*/
function postBody(connection, payload) {
  if (_reactNative.Platform.OS !== 'ios') {
    return Promise.resolve({
      success: false,
 ...
 */
function getAllHealthKitPermissions() {
  if (_reactNative.Platform.OS !== 'ios') {
    return Promise.resolve({
      success: false,
 ...
 */
function requestAllHealthKitPermissions() {
  if (_reactNative.Platform.OS !== 'ios') {
    return Promise.resolve({
      success: false,
      error: 'Only available on iOS'
