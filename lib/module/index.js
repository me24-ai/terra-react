...
const TerraReact = NativeModules.TerraReact ? NativeModules.TerraReact : new Proxy({}, {
  get() {
...
export function initConnection(connection, token, schedulerOn) {
  ...
  let customWritePermissions_ = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
...
export function getMenstruation(connection, startDate, endDate) {
  let toWebhook = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return new Promise((resolve, reject) => {
...
export function getDaily(connection, startDate, endDate) {
  let toWebhook = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return new Promise((resolve, reject) => {
...
export function postBody(connection, payload) {
  ...
  const native = new Promise((resolve, reject) => {
    TerraReact.postBody(ConnectionToString(connection), payload).then(d => {
      resolve({
        success: d.success,
        error: d.error
      });
